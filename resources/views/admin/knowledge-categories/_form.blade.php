...
<div class="grid gap-5">
    <div>
        ...
        <input id="name" name="name" type="text" value="{{ old('name', $knowledgeCategory->name ?? '') }}"
    ...
    <div>
        ...
        <input id="slug" name="slug" type="text" value="{{ old('slug', $knowledgeCategory->slug ?? '') }}"
            class="w-full rounded-2xl border border-slate-300 px-4 py-3 text-sm outline-none transition focus:border-[var(--primary-color)] focus:ring-4 focus:ring-[var(--blue-low-opacity)]/40">
    </div>
    ...
    <div>
        ...
        <textarea id="description" name="description" rows="4"
            class="w-full rounded-3xl border border-slate-300 px-4 py-3 text-sm outline-none transition focus:border-[var(--primary-color)] focus:ring-4 focus:ring-[var(--blue-low-opacity)]/40">{{ old('description', $knowledgeCategory->description ?? '') }}</textarea>
    </div>
