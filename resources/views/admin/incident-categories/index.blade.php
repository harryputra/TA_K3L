...
@section('content')
    <section class="space-y-6">
        <div class="flex flex-col justify-between gap-4 rounded-[2rem] bg-white p-8 shadow-sm ring-1 ring-slate-200 lg:flex-row lg:items-center">
            ...
            <a href="{{ route('admin.incident-categories.create') }}" class="inline-flex items-center justify-center rounded-full bg-cyan-700 px-5 py-3 text-sm font-semibold text-white transition hover:bg-cyan-800">
                Tambah Kategori
            </a>
        </div>
                    ...
                    <tbody class="divide-y divide-slate-100">
                        @forelse ($incidentCategories as $incidentCategory)
                            <tr>
                                ...
                                <td class="px-6 py-4">
                                    <a href="{{ route('admin.incident-categories.edit', $incidentCategory) }}" class="font-semibold text-cyan-700 hover:text-cyan-800">Edit</a>
                                </td>
                            </tr>
                        @empty
                            <tr>
